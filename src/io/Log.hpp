...
public:
  ...
  /*  Snagar */
  static void logMsgThread(const std::string &message, missionx::format_type format = format_type::none);

  static void logMsg(const std::string &message, bool isThread = false, missionx::format_type format = format_type::none, bool isHeader = false);

  static void logMsgNone(const std::string &message, bool isThread = false);
  
  static void logMsgExtScript(const std::string &message, bool isThread = false);

  static void logMsgNoneCR(const std::string &message, bool isThread = false);

  static void logMsgErr(const std::string &message, bool isThread = false);

  static void logMsgWarn(const std::string &message, bool isThread = false);
  ...
  static void printHeaderToLog(const std::string &s, bool isThread = false, format_type format = format_type::header);
  ...
  static void logToFile(const std::string& msg, int mode, bool isThread = false);
