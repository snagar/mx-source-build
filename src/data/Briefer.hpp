...
public:
  ...
  void positionPlane2(const bool inflag_setupForcePlanePositioning = false,const bool inflag_setupChangeHeadingEvenIfPlaneIn_20meter_radius = false, const int inXplaneVersion_i = 0);
