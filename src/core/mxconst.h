// **************************************************************************
// Generated by mxconst_builder.sh on: "2025 Apr 17, 20:54:27"
//
...
// ---> MX_FILE_SAVE_EXTENTION
typedef struct st_mx_file_save_extention {
  std::string  value =  ".savepoint.sav"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_mx_file_save_extention;
// -- getter -- 
static std::string  get_MX_FILE_SAVE_EXTENTION() {
  static const st_mx_file_save_extention instance;
  return instance.getValue();
}
// MX_FILE_SAVE_EXTENTION <---

// ---> MX_FILE_SAVE_DREF_EXTENTION
typedef struct st_mx_file_save_dref_extention {
  std::string  value =  ".dataref.txt"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_mx_file_save_dref_extention;
// -- getter -- 
static std::string  get_MX_FILE_SAVE_DREF_EXTENTION() {
  static const st_mx_file_save_dref_extention instance;
  return instance.getValue();
}
// MX_FILE_SAVE_DREF_EXTENTION <---
...
// ---> XML_EXTENTION
typedef struct st_xml_extention {
  std::string  value =  ".xml"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_xml_extention;
// -- getter -- 
static std::string  get_XML_EXTENTION() {
  static const st_xml_extention instance;
  return instance.getValue();
}
// XML_EXTENTION <---
...
// ---> SETUP_AUTHORIZATIOJN_KEY
typedef struct st_setup_authorizatiojn_key {
  std::string value =  "setup_authorization_key_s"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_setup_authorizatiojn_key;
// -- getter -- 
static std::string get_SETUP_AUTHORIZATIOJN_KEY() {
  static const st_setup_authorizatiojn_key instance;
  return instance.getValue();
}
// SETUP_AUTHORIZATIOJN_KEY <---
...
// ---> ATTRIB_FORMATED_NAV_POINTS
typedef struct st_attrib_formated_nav_points {
  std::string value =  "formated_nav_points"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_formated_nav_points;
// -- getter -- 
static std::string get_ATTRIB_FORMATED_NAV_POINTS() {
  static const st_attrib_formated_nav_points instance;
  return instance.getValue();
}
// ATTRIB_FORMATED_NAV_POINTS <---
