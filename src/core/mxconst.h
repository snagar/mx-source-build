// **************************************************************************
// Generated by "%script_name%" on: "%generated%"
//
...
// OPT_AI_LLM_SERVER_TIMEOUT <---
// ---> OPT_AI_USE_LLM_TO_GENERATE_MISSION
typedef struct st_opt_ai_use_llm_to_generate_mission {
  std::string value =  "use_llm_to_generate_mission"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_use_llm_to_generate_mission;
// -- getter -- 
static std::string get_OPT_AI_USE_LLM_TO_GENERATE_MISSION() {
  static const st_opt_ai_use_llm_to_generate_mission instance;
  return instance.getValue();
}
// OPT_AI_USE_LLM_TO_GENERATE_MISSION <---
