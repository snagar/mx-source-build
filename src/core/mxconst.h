// **************************************************************************
// Generated by "mxconst_builder.py" on: "2026 Apr 08, 10:45:46"
//
...
// BITMAP_BTN_ACT_TURBOPROP <---
// ---> BITMAP_BTN_ACT_HEL_MED_ACCIDENT
typedef struct st_bitmap_btn_act_hel_med_accident {
  std::string value =  "act_med_h_acc_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_hel_med_accident;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_HEL_MED_ACCIDENT() {
  static const st_bitmap_btn_act_hel_med_accident instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_HEL_MED_ACCIDENT <---
