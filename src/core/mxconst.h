// **************************************************************************
// Generated by "mxconst_builder.py" on: "2025 Dec 28, 23:07:17"
//
...
// ATTRIB_REPLACE_PITCH <---
// ---> ATTRIB_REPLACE_ROLE
typedef struct st_attrib_replace_role {
  std::string  value =  "replace_role"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_replace_role;
// -- getter -- 
static std::string  get_ATTRIB_REPLACE_ROLE() {
  static const st_attrib_replace_role instance;
  return instance.getValue();
}
// ATTRIB_REPLACE_ROLE <---
