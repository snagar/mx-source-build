// **************************************************************************
// Generated by "mxconst_builder.py" on: "2026 Apr 12, 13:11:36"
//
...
typedef struct st_overpass_xml_urls {
  std::string  value =  "<" + get_ELEMENT_OVERPASS() + ">" + "<url>https://overpass.kumi.systems/api/interpreter</url>       " + "<url>https://overpass-api.de/api/interpreter</url> " + "<url>https://lz4.overpass-api.de/api/interpreter</url> " + "<url>https://overpass.osm.jp/api/interpreter</url> " + "<url>https://maps.mail.ru/osm/tools/overpass/api/interpreter</url> " + "<url>https://z.overpass-api.de/api/interpreter</url> " + "<url>https://overpass.osm.ch/api/interpreter</url> " + "<url>https://overpass.private.coffee/api/interpreter</url> " + "</" + get_ELEMENT_OVERPASS() + ">";
[[nodiscard]]  std::string  getValue() const { return value; }
