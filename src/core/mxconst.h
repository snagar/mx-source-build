// **************************************************************************
// Generated by "mxconst_builder.py" on: "2026 Sep 05, 16:37:09"
//
// Do not modify this class file since it will be overridden by the generated script.
...
// vecMarkerTypeOptions_markers <---
// inline static^std::map<mx_ils_type_enum, std::string>^mapILS_types^{ { mx_ils_type_enum::LOC, "LOC" },{ mx_ils_type_enum::ILS_cat_I, "ILS-cat-I" }, { mx_ils_type_enum::ILS_cat_II, "ILS-cat-II" },{ mx_ils_type_enum::ILS_cat_III, "ILS-cat-III" }, { mx_ils_type_enum::IGS, "IGS" }, { mx_ils_type_enum::LDA, "LDA" }, { mx_ils_type_enum::SDF, "SDF" }, { mx_ils_type_enum::GLS, "GLS" }, { mx_ils_type_enum::LP, "LP" }, { mx_ils_type_enum::LPV, "LPV" } };   ^ // v26.04.5

// ---> MISSIONX_PROPERTIES_FILE_NAME
typedef struct st_missionx_properties_file_name {
  std::string value = "missionx_pref_v3.xml"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_missionx_properties_file_name;
// -- getter -- 
static std::string get_MISSIONX_PROPERTIES_FILE_NAME() {
  static const st_missionx_properties_file_name instance;
  return instance.getValue();
}
// MISSIONX_PROPERTIES_FILE_NAME <---
// ---> MISSIONX_RANDOM_PACK_FILENAME
typedef struct st_missionx_random_pack_filename {
  std::string value = "missionx_random_pack.zip"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_missionx_random_pack_filename;
// -- getter -- 
static std::string get_MISSIONX_RANDOM_PACK_FILENAME() {
  static const st_missionx_random_pack_filename instance;
  return instance.getValue();
}
// MISSIONX_RANDOM_PACK_FILENAME <---
...
// TEXT_TYPE_MSG_POPUP <---
// ---> TEXT_TYPE_FIX_HINT_REG
typedef struct st_text_type_fix_hint_reg {
  std::string  value =  "fix_hint_reg";     
[[nodiscard]]  std::string  getValue() const { return value; }
} st_text_type_fix_hint_reg;
// -- getter -- 
static std::string  get_TEXT_TYPE_FIX_HINT_REG() {
  static const st_text_type_fix_hint_reg instance;
  return instance.getValue();
}
// TEXT_TYPE_FIX_HINT_REG <---
// ---> TEXT_TYPE_FIX_HINT_MED
typedef struct st_text_type_fix_hint_med {
  std::string  value =  "fix_hint_med";     
[[nodiscard]]  std::string  getValue() const { return value; }
} st_text_type_fix_hint_med;
// -- getter -- 
static std::string  get_TEXT_TYPE_FIX_HINT_MED() {
  static const st_text_type_fix_hint_med instance;
  return instance.getValue();
}
// TEXT_TYPE_FIX_HINT_MED <---
...
static constexpr  double MIN_POSITION_DISTANCE_D =  500000.0;  // // v25.08.1 // v25.10.2 represents ~268 nautical miles
...
// ATTRIB_XP_VERSION <---
// ---> ATTRIB_SCENERY_HASH
typedef struct st_attrib_scenery_hash {
  std::string  value =  "scenery_hash";   
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_scenery_hash;
// -- getter -- 
static std::string  get_ATTRIB_SCENERY_HASH() {
  static const st_attrib_scenery_hash instance;
  return instance.getValue();
}
// ATTRIB_SCENERY_HASH <---
...
static constexpr  int MAX_ITEMS_IN_PLANE_INVENTORY = 30;  // // v25.05.1 resize to 30 and only for plane. External inventory should not have a limitation.// v3.0.213.4 // used in em_reset_inventory_item_table() function.
static constexpr  int MAX_ITEMS_IN_EXTERNAL_INVENTORY = 100;  // // v25.05.1 limit external inventory item number.
...
static constexpr  double DOUBLE_UNDEFINED =  -1.0; // used with gen_target_base_on_icao_or_near_types();
...
// <url>https://overpass-api.de/api/interpreter</url>
// <url>https://lz4.overpass-api.de/api/interpreter</url>
// <url>https://overpass.osm.jp/api/interpreter</url>
// <url>https://maps.mail.ru/osm/tools/overpass/api/interpreter</url>
// <url>https://z.overpass-api.de/api/interpreter</url>
// <url>https://overpass.osm.ch/api/interpreter</url>
// <url>https://overpass.private.coffee/api/interpreter</url>
//</OVERPASS>)";

// const static ^std::string ^OVERPASS_XML_URLS                               ^ "<" + get_ELEMENT_OVERPASS() + ">" + "<url>https://overpass.kumi.systems/api/interpreter</url>       " + "<url>https://overpass-api.de/api/interpreter</url> " + "<url>https://lz4.overpass-api.de/api/interpreter</url> " + "<url>https://overpass.osm.jp/api/interpreter</url> " + "<url>https://maps.mail.ru/osm/tools/overpass/api/interpreter</url> " + "<url>https://z.overpass-api.de/api/interpreter</url> " + "<url>https://overpass.osm.ch/api/interpreter</url> " + "<url>https://overpass.private.coffee/api/interpreter</url> " + "</" + get_ELEMENT_OVERPASS() + ">";
// ---> OVERPASS_XML_URLS
typedef struct st_overpass_xml_urls {
  std::string  value =  "<" + get_ELEMENT_OVERPASS() + ">" + "<url>https://overpass.kumi.systems/api/interpreter</url>       " + "<url>https://overpass-api.de/api/interpreter</url> " + "<url>https://overpass.private.coffee/api/interpreter</url> " + "</" + get_ELEMENT_OVERPASS() + ">";
[[nodiscard]]  std::string  getValue() const { return value; }
...
// ATTRIB_DUMMY_LEG_ITERATIONS <---
// ---> ATTRIB_MISSION_TYPE
typedef struct st_attrib_mission_type {
  std::string  value =  "mission_type"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_mission_type;
// -- getter -- 
static std::string  get_ATTRIB_MISSION_TYPE() {
  static const st_attrib_mission_type instance;
  return instance.getValue();
}
// ATTRIB_MISSION_TYPE <---
...
// ELEMENT_METAR <---
// ---> ELEMENT_METAR_TIME
typedef struct st_element_metar_time {
  std::string  value =  "metar_time"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_element_metar_time;
// -- getter -- 
static std::string  get_ELEMENT_METAR_TIME() {
  static const st_element_metar_time instance;
  return instance.getValue();
}
// ELEMENT_METAR_TIME <---
...
// ATTRIB_REPLACE_ELEV_FT <---
// ---> ATTRIB_REPLACE_HEADING_PSI
typedef struct st_attrib_replace_heading_psi {
  std::string  value =  "replace_heading_psi"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_replace_heading_psi;
// -- getter -- 
static std::string  get_ATTRIB_REPLACE_HEADING_PSI() {
  static const st_attrib_replace_heading_psi instance;
  return instance.getValue();
}
// ATTRIB_REPLACE_HEADING_PSI <---
// ---> ATTRIB_REPLACE_PITCH
typedef struct st_attrib_replace_pitch {
  std::string  value =  "replace_pitch"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_replace_pitch;
// -- getter -- 
static std::string  get_ATTRIB_REPLACE_PITCH() {
  static const st_attrib_replace_pitch instance;
  return instance.getValue();
}
// ATTRIB_REPLACE_PITCH <---
// ---> ATTRIB_REPLACE_ROLL
typedef struct st_attrib_replace_roll {
  std::string  value =  "replace_roll"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_replace_roll;
// -- getter -- 
static std::string  get_ATTRIB_REPLACE_ROLL() {
  static const st_attrib_replace_roll instance;
  return instance.getValue();
}
// ATTRIB_REPLACE_ROLL <---
// ---> ATTRIB_REPLACE_KEEP_UNTIL_LEG
typedef struct st_attrib_replace_keep_until_leg {
  std::string  value =  "replace_keep_until_leg"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_replace_keep_until_leg;
// -- getter -- 
static std::string  get_ATTRIB_REPLACE_KEEP_UNTIL_LEG() {
  static const st_attrib_replace_keep_until_leg instance;
  return instance.getValue();
}
// ATTRIB_REPLACE_KEEP_UNTIL_LEG <---
...
// ATTRIB_INSTANCE_NAME <---
// ---> ATTRIB_INSTANCE_CREATED_IN_LEG
typedef struct st_attrib_instance_created_in_leg {
  std::string  value =  "instance_created_in_leg"; 
[[nodiscard]]  std::string  getValue() const { return value; }
} st_attrib_instance_created_in_leg;
// -- getter -- 
static std::string  get_ATTRIB_INSTANCE_CREATED_IN_LEG() {
  static const st_attrib_instance_created_in_leg instance;
  return instance.getValue();
}
// ATTRIB_INSTANCE_CREATED_IN_LEG <---
...
// OPT_DISPLAY_VISUAL_CUES <---
// ---> OPT_DISPLAY_UI_CLOCKS
typedef struct st_opt_display_ui_clocks {
  std::string value =  "display_ui_clocks"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_display_ui_clocks;
// -- getter -- 
static std::string get_OPT_DISPLAY_UI_CLOCKS() {
  static const st_opt_display_ui_clocks instance;
  return instance.getValue();
}
// OPT_DISPLAY_UI_CLOCKS <---
// ---> OPT_DISPLAY_UI_FPS
typedef struct st_opt_display_ui_fps {
  std::string value =  "opt_display_ui_fps"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_display_ui_fps;
// -- getter -- 
static std::string get_OPT_DISPLAY_UI_FPS() {
  static const st_opt_display_ui_fps instance;
  return instance.getValue();
}
// OPT_DISPLAY_UI_FPS <---
...
// OPT_FLIGHT_LEG_PROGRESS_COUNTER <---
// ---> OPT_DISABLE_INVENTORY_IMAGE_LOAD
typedef struct st_opt_disable_inventory_image_load {
  std::string value =  "disable_inventory_image_load"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_disable_inventory_image_load;
// -- getter -- 
static std::string get_OPT_DISABLE_INVENTORY_IMAGE_LOAD() {
  static const st_opt_disable_inventory_image_load instance;
  return instance.getValue();
}
// OPT_DISABLE_INVENTORY_IMAGE_LOAD <---
// ---> OPT_AI_USE_AI
typedef struct st_opt_ai_use_ai {
  std::string value =  "ai_use_ai"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_use_ai;
// -- getter -- 
static std::string get_OPT_AI_USE_AI() {
  static const st_opt_ai_use_ai instance;
  return instance.getValue();
}
// OPT_AI_USE_AI <---
// ---> OPT_AI_SERVER_URL
typedef struct st_opt_ai_server_url {
  std::string value =  "ai_server_url"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_server_url;
// -- getter -- 
static std::string get_OPT_AI_SERVER_URL() {
  static const st_opt_ai_server_url instance;
  return instance.getValue();
}
// OPT_AI_SERVER_URL <---
// ---> OPT_AI_AUTH_KEY
typedef struct st_opt_ai_auth_key {
  std::string value =  "ai_auth_key"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_auth_key;
// -- getter -- 
static std::string get_OPT_AI_AUTH_KEY() {
  static const st_opt_ai_auth_key instance;
  return instance.getValue();
}
// OPT_AI_AUTH_KEY <---
// ---> OPT_AI_DEFAULT_AUTH_KEY
typedef struct st_opt_ai_default_auth_key {
  std::string value =  "missionx_no_auth"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_default_auth_key;
// -- getter -- 
static std::string get_OPT_AI_DEFAULT_AUTH_KEY() {
  static const st_opt_ai_default_auth_key instance;
  return instance.getValue();
}
// OPT_AI_DEFAULT_AUTH_KEY <---
// ---> OPT_AI_LLM_SERVER_TIMEOUT
typedef struct st_opt_ai_llm_server_timeout {
  std::string value =  "llm_server_timeout"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_opt_ai_llm_server_timeout;
// -- getter -- 
static std::string get_OPT_AI_LLM_SERVER_TIMEOUT() {
  static const st_opt_ai_llm_server_timeout instance;
  return instance.getValue();
}
// OPT_AI_LLM_SERVER_TIMEOUT <---
//const static ^std::string^                OPT_SEMI_ACTIVITY_PICKED_BY_THE_USER                   ^ "semi_activity_picked_by_the_user"; ^// v26.09.1 Used with the user semi activity screen.
//const static ^std::string^                OPT_AI_USE_LLM_TO_GENERATE_MISSION                     ^ "use_llm_to_generate_mission"; ^// v26.09.1 Used with the user semi activity screen.
//const static ^std::string^                OPT_AI_USE_LLM_TO_SUGGEST_WAYPOINTS                    ^ "use_llm_to_suggest_waypoints"; ^// v26.09.2 Used with the user semi activity screen.
//const static ^std::string^                OPT_AI_USE_LLM_TO_GENERATE_BACKGROUND_STORY            ^ "use_llm_to_generate_background_story"; ^// v26.09.2 Used with the user semi activity screen.
...
static constexpr  double SLIDER_ILS_MIN_VFR_SEARCH_RADIUS =  5;  // // VFR LAYER // v26.04.4 used in ILS screen
static constexpr  double SLIDER_ILS_MAX_VFR_SEARCH_RADIUS =  500;  // // VFR LAYER // v26.04.4 used in ILS screen
//static constexpr ^double  ^               SLIDER_SHORTEST_MIN_ILS_SEARCH_RADIUS                ^ 5; ^// ILS LAYER // v3.0.253.6 holds the minimum search ILS airport // v25.08.1 was 50nm
static constexpr  float SLIDER_ILS_MIN_SEARCH_RADIUS =  250.0;  // // v3.0.253.6 holds the minimum slider radius value for the ILS search screen.
static constexpr  float SLIDER_ILS_MAX_SEARCH_RADIUS =  9000.0;  // // v3.0.253.6 holds the maximum slider radius value for the ILS search screen.
static constexpr  int SLIDER_ILS_SHORTEST_RW_LENGTH_MT =  50;  // // v3.0.253.6 (was 740) holds the shortest slider value allowed for runway length (ILS layer).
static constexpr  int SLIDER_ILS_LONGEST_RW_LENGTH_MT =  3740;  // // v3.0.253.6 holds the longest slider value for runway length (ILS layer)
...
// BITMAP_BTN_FLIGHTPLANDB <---
// ---> BITMAP_BTN_FULL_CONTROL
typedef struct st_bitmap_btn_full_control {
  std::string value =  "full_control_256.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_full_control;
// -- getter -- 
static std::string get_BITMAP_BTN_FULL_CONTROL() {
  static const st_bitmap_btn_full_control instance;
  return instance.getValue();
}
// BITMAP_BTN_FULL_CONTROL <---
// ---> BITMAP_BTN_SOME_CONTROL
typedef struct st_bitmap_btn_some_control {
  std::string value =  "some_control_256.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_some_control;
// -- getter -- 
static std::string get_BITMAP_BTN_SOME_CONTROL() {
  static const st_bitmap_btn_some_control instance;
  return instance.getValue();
}
// BITMAP_BTN_SOME_CONTROL <---
// ---> BITMAP_BTN_FULL_AUTOMATION
typedef struct st_bitmap_btn_full_automation {
  std::string value =  "no_control_256.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_full_automation;
// -- getter -- 
static std::string get_BITMAP_BTN_FULL_AUTOMATION() {
  static const st_bitmap_btn_full_automation instance;
  return instance.getValue();
}
// BITMAP_BTN_FULL_AUTOMATION <---
// ---> BITMAP_BTN_ACT_GA
typedef struct st_bitmap_btn_act_ga {
  std::string value =  "act_ga_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_ga;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_GA() {
  static const st_bitmap_btn_act_ga instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_GA <---
// ---> BITMAP_BTN_ACT_JET
typedef struct st_bitmap_btn_act_jet {
  std::string value =  "act_jet_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_jet;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_JET() {
  static const st_bitmap_btn_act_jet instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_JET <---
// ---> BITMAP_BTN_ACT_AIRLINE
typedef struct st_bitmap_btn_act_airline {
  std::string value =  "act_airline_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_airline;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_AIRLINE() {
  static const st_bitmap_btn_act_airline instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_AIRLINE <---
// ---> BITMAP_BTN_ACT_CARGO
typedef struct st_bitmap_btn_act_cargo {
  std::string value =  "act_cargo_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_cargo;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_CARGO() {
  static const st_bitmap_btn_act_cargo instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_CARGO <---
// ---> BITMAP_BTN_ACT_AIRLINE_H
typedef struct st_bitmap_btn_act_airline_h {
  std::string value =  "act_airline_h_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_airline_h;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_AIRLINE_H() {
  static const st_bitmap_btn_act_airline_h instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_AIRLINE_H <---
// ---> BITMAP_BTN_ACT_CARGO_H
typedef struct st_bitmap_btn_act_cargo_h {
  std::string value =  "act_cargo_h_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_cargo_h;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_CARGO_H() {
  static const st_bitmap_btn_act_cargo_h instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_CARGO_H <---
// ---> BITMAP_BTN_ACT_TURBOPROP
typedef struct st_bitmap_btn_act_turboprop {
  std::string value =  "act_tp_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_turboprop;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_TURBOPROP() {
  static const st_bitmap_btn_act_turboprop instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_TURBOPROP <---
// ---> BITMAP_BTN_ACT_HELOS_ACC
typedef struct st_bitmap_btn_act_helos_acc {
  std::string value =  "act_helos_acc_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_helos_acc;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_HELOS_ACC() {
  static const st_bitmap_btn_act_helos_acc instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_HELOS_ACC <---
// ---> BITMAP_BTN_ACT_HELOS_OIL
typedef struct st_bitmap_btn_act_helos_oil {
  std::string value =  "act_helos_oil_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_helos_oil;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_HELOS_OIL() {
  static const st_bitmap_btn_act_helos_oil instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_HELOS_OIL <---
// ---> BITMAP_BTN_ACT_HELOS_SRP
typedef struct st_bitmap_btn_act_helos_srp {
  std::string value =  "act_helos_srp_01.png"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_bitmap_btn_act_helos_srp;
// -- getter -- 
static std::string get_BITMAP_BTN_ACT_HELOS_SRP() {
  static const st_bitmap_btn_act_helos_srp instance;
  return instance.getValue();
}
// BITMAP_BTN_ACT_HELOS_SRP <---
...
// ATTRIB_LOCATION_VALUE <---
// ---> ATTRIB_LOCATION_PROPERTIES
typedef struct st_attrib_location_properties {
  std::string value =  "location_properties"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_location_properties;
// -- getter -- 
static std::string get_ATTRIB_LOCATION_PROPERTIES() {
  static const st_attrib_location_properties instance;
  return instance.getValue();
}
// ATTRIB_LOCATION_PROPERTIES <---
...
// PLANE_TYPE_HEAVY <---
// ---> PLANE_IS_AMPHIBIAN
typedef struct st_plane_is_amphibian {
  std::string value =  "is_amphibian"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_plane_is_amphibian;
// -- getter -- 
static std::string get_PLANE_IS_AMPHIBIAN() {
  static const st_plane_is_amphibian instance;
  return instance.getValue();
}
// PLANE_IS_AMPHIBIAN <---
// ---> ELEMENT_CONTENT
...
// GENERATE_TYPE_CARGO <---
// ---> GENERATE_TYPE_PASSENGER
typedef struct st_generate_type_passenger {
  std::string value =  "passenger"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_generate_type_passenger;
// -- getter -- 
static std::string get_GENERATE_TYPE_PASSENGER() {
  static const st_generate_type_passenger instance;
  return instance.getValue();
}
// GENERATE_TYPE_PASSENGER <---
...
// ATTRIB_SET_NAME <---
// ---> ATTRIB_SLOPE_SET_NAME
typedef struct st_attrib_slope_set_name {
  std::string value =  "slope_set_name"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_slope_set_name;
// -- getter -- 
static std::string get_ATTRIB_SLOPE_SET_NAME() {
  static const st_attrib_slope_set_name instance;
  return instance.getValue();
}
// ATTRIB_SLOPE_SET_NAME <---
...
// ATTRIB_COPY_LEG_AS_IS_B <---
// ---> ATTRIB_COPY_AS_IS_B
typedef struct st_attrib_copy_as_is_b {
  std::string value =  "copy_as_is_b"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_copy_as_is_b;
// -- getter -- 
static std::string get_ATTRIB_COPY_AS_IS_B() {
  static const st_attrib_copy_as_is_b instance;
  return instance.getValue();
}
// ATTRIB_COPY_AS_IS_B <---
...
// SETUP_SIMBRIEF_PILOT_ID <---
// ---> SETUP_SIMBRIEF_AUTO_LOAD_INTO_NOTES
typedef struct st_setup_simbrief_auto_load_into_notes {
  std::string value =  "simbrief_auto_load_into_notes"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_setup_simbrief_auto_load_into_notes;
// -- getter -- 
static std::string get_SETUP_SIMBRIEF_AUTO_LOAD_INTO_NOTES() {
  static const st_setup_simbrief_auto_load_into_notes instance;
  return instance.getValue();
}
// SETUP_SIMBRIEF_AUTO_LOAD_INTO_NOTES <---
...
// PROP_SORT_FPLN_BY <---
// ---> PROP_OSM_GEN_FILE
typedef struct st_prop_osm_gen_file {
  std::string value =  "osm_gen_file"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_prop_osm_gen_file;
// -- getter -- 
static std::string get_PROP_OSM_GEN_FILE() {
  static const st_prop_osm_gen_file instance;
  return instance.getValue();
}
// PROP_OSM_GEN_FILE <---
...
typedef struct st_default_overpass_url {
  std::string value =  "https://overpass-api.de/api/interpreter"; 
[[nodiscard]]  std::string getValue() const { return value; }
...
// ATTRIB_TARGET_INVENTORY <---
// ---> ATTRIB_INHIBIT_MXPAD_B
typedef struct st_attrib_inhibit_mxpad_b {
  std::string value =  "inhibit_mxpad_b"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_inhibit_mxpad_b;
// -- getter -- 
static std::string get_ATTRIB_INHIBIT_MXPAD_B() {
  static const st_attrib_inhibit_mxpad_b instance;
  return instance.getValue();
}
// ATTRIB_INHIBIT_MXPAD_B <---
...
// Simbrief
// ---> ELEMENT_SIMBRIEF_ROOT_OFP
typedef struct st_element_simbrief_root_ofp {
  std::string value =  "OFP"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_element_simbrief_root_ofp;
// -- getter -- 
static std::string get_ELEMENT_SIMBRIEF_ROOT_OFP() {
  static const st_element_simbrief_root_ofp instance;
  return instance.getValue();
}
// ELEMENT_SIMBRIEF_ROOT_OFP <---
// ---> ELEMENT_GENERAL
...
// ELEMENT_ROUTE_NAVIGRAPH <---
// ---> ELEMENT_ICAO_AIRLINE
typedef struct st_element_icao_airline {
  std::string value =  "icao_airline"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_element_icao_airline;
// -- getter -- 
static std::string get_ELEMENT_ICAO_AIRLINE() {
  static const st_element_icao_airline instance;
  return instance.getValue();
}
// ELEMENT_ICAO_AIRLINE <---
...
// ELEMENT_DESTINATION <---
// ---> ELEMENT_ALTERNATE
typedef struct st_element_alternate {
  std::string value =  "alternate"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_element_alternate;
// -- getter -- 
static std::string get_ELEMENT_ALTERNATE() {
  static const st_element_alternate instance;
  return instance.getValue();
}
// ELEMENT_ALTERNATE <---
// ---> ELEMENT_PLAN_RWY
...
typedef struct st_default_overpass_ways_filter {
  std::string value =  "[timeout:25];way[\"highway\"~\"(primary|secondary|tertiary|residential|service|living_street|track)\"]({{bbox}});out geom;"; 
[[nodiscard]]  std::string getValue() const { return value; }
...
// DEFAULT_OVERPASS_WAYS_FILTER <---
// ---> GPS_WP
typedef struct st_gps_wp {
  std::string value =  "wp";                 
[[nodiscard]]  std::string getValue() const { return value; }
} st_gps_wp;
// -- getter -- 
static std::string get_GPS_WP() {
  static const st_gps_wp instance;
  return instance.getValue();
}
// GPS_WP <---

// MEDEVAC Sub Categories
constexpr static  std::string_view CAT_ANY_LOCATION =  "Any Location - Rescue";  // // v25.05.1 Used in medevac categories
constexpr static  std::string_view CAT_ACCIDENT_OSM =  "Accident (OSM)";  // // v25.05.1 Used in medevac categories
constexpr static  std::string_view CAT_SURPRISE_ME =  "(WIP) Surprise Me (OSM)";  // // v25.05.1 Used in medevac categories

// ---> ATTRIB_SURPRISE_ME_SUB_CAT_B
typedef struct st_attrib_surprise_me_sub_cat_b {
  std::string value =  "surprise_me_sub_cat_b"; 
[[nodiscard]]  std::string getValue() const { return value; }
} st_attrib_surprise_me_sub_cat_b;
// -- getter -- 
static std::string get_ATTRIB_SURPRISE_ME_SUB_CAT_B() {
  static const st_attrib_surprise_me_sub_cat_b instance;
  return instance.getValue();
}
// ATTRIB_SURPRISE_ME_SUB_CAT_B <---
constexpr static  bool DEFAULT_AUTO_LOAD_ROUTE_TO_GPS_OR_FMS_B = true;  // // v25.05.1 default value for PROP_AUTO_LOAD_ROUTE_TO_GPS_OR_FMS_B if it does not exists in the property file.
constexpr static  std::string_view SEARCH_SURPRISE_ME_TEXT =  "surprise me"; // // v25.05.1
constexpr static  std::string_view DEFAULT_OSM_GEN_FILE =  "libs/osm_gen.xml"; // // v25.06.1
constexpr static  std::string_view DEFAULT_CUSTOM_OSM_GEN_FILE =  "libs/custom_osm_gen.xml"; // // v25.06.1 user own version of the osm_gen.xml file. It won't be overridden by plugin upgrade nor Skunkcrafts application.

constexpr static  std::string_view DEFAULT_LAND_OR_INV_RADIUS_MT =  "350"; // // v25.06.1
constexpr static  std::string_view DEFAULT_HOVER_RADIUS_MT =  "40"; // // v25.06.1
constexpr static  std::string_view DEFAULT_LAND_ONLY_RADIUS_MT =  "20"; // // v25.06.1
constexpr static  std::string_view DEFAULT_HOVER_VOL_HEIGHT_FOR_OSM_FT =  "328"; // // v25.06.1

constexpr static  std::string_view BLANK_3D_OBJ =  "blank"; // // v26.01.5 Used with <display_object>. If above water, the plugin might use a "blank" obj3d to skip.
