...
mx_is_plane_in_rw_area(sqlite3_context* context, int argc, sqlite3_value** argv)
{
  ...
  switch (sqlite3_value_type(argv[0]))
  {
    ...
    default:
    {
      ...
      // calculate Top Left
      mxCalcPointBasedOnDistanceAndBearing_2DPlane(&rwTopLeftPos.lat, &rwTopLeftPos.lon, rwCenterEdge1.lat, rwCenterEdge1.lon, bearing_between_rw_edges + -90.0f, dRunwayWidthInMeters / 2.0, planet_great_circle);
      ...
      // calculate Top Right
      mxCalcPointBasedOnDistanceAndBearing_2DPlane(&rwTopRightPos.lat, &rwTopRightPos.lon, rwCenterEdge2.lat, rwCenterEdge2.lon, bearing_between_rw_edges - -90.0f, dRunwayWidthInMeters / 2.0, planet_great_circle);
